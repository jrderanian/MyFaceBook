...
class User: Codable {
    ...
    init(id: UUID, isActive: Bool, name: String, age: Int, company: String, email: String, address: String, about: String, registered: String, friends: [Friend], tags: [String], registeredDate: Date) {
        self.id = id
    ...
    required init(from decoder: Decoder) throws {
        ...
        // TODO: translate string into date right here
        registered = try container.decode(String.self, forKey: .registered)
        friends = try container.decode([Friend].self, forKey: .friends)
        tags = try container.decode([String].self, forKey: .tags)
        
//        var registeredDate =  { // Computed property to convert to Date
//            // MARK: Finally found the datetimestamp format
//            //"2014-07-05T04:25:04-01:00"
//            
//            // https://developer.apple.com/documentation/foundation/dateformatter
